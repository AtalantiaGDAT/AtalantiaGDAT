    ...
    void Update()
    {
        ...
        for (int h = 0; h < hands.Count; h++)
        {
            ...
            { //Begin right hand code
                ...
                float rightGrab = hand.GrabStrength; //Shows on a scale of 0 to 1 how much the entire hand is grasping
                ...
                float rightHeight = (hand.PalmPosition.y + 0.3f) * 100.0f;

                Debug.Log("Hello"/*rightHeight*/);
            ...
            { //Begin left hand code
                ...
                float leftHeight = (hand.PalmPosition.y + 0.3f) * 100f;
